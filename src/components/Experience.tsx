import { Briefcase, Calendar, MapPin, Trophy, GraduationCap, ExternalLink } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              My professional journey and notable accomplishments in technology and innovation
            </p>
          </div>
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <div>
                    ...
                    <p className="text-secondary font-medium text-lg">Computer Engineering</p>
                  </div>
                  <div className="text-muted-foreground">
                    <div className="flex items-center gap-2 mb-1">
                      <Calendar className="h-4 w-4" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="px-4 py-2 rounded-lg bg-secondary/10 border border-secondary/20">
                      <span className="text-secondary font-semibold text-lg">CGPA: 8.64/10</span>
                    </div>
                    <div className="text-muted-foreground">
                      <span className="text-sm">Final Year Student</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Data Structures', 'Algorithms', 'Database Systems', 'Software Engineering', 'Web Development', 'Computer Networks'].map((course) => (
                        <span
                          key={course}
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {achievements.map((achievement, index) => (
                <div key={achievement.title} className="gradient-card rounded-xl p-6 text-center group">
          ...
          <div className="mt-12 text-center">
            <div className="gradient-card rounded-xl p-6 max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-2">Shramik Junior College</p>
